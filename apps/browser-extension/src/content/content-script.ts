...
// NOTE: the pocket-demo barrier resolution (missing accessible name ->
// <a11y-field-proxy>) used to live here, but customElements is null in a
// content script's isolated world (this file) — Custom Elements only work
// in the main world. That logic now lives in main-world-barriers.ts,
// injected via manifest.json's content_scripts[].world = "MAIN" entry.
